...
public class BasicBehaviour : MonoBehaviour
{
	...
	[SerializeField] private int currentBehaviour;        // Reference to the current player behaviour.
	...
	[SerializeField] private List<GenericBehaviour> behaviours;            // The list containing all the enabled player behaviours.
	[SerializeField] private List<GenericBehaviour> overridingBehaviours;  // List of current overriding behaviours.
	...
	// Use to change to one or more behaviours that must overlap the active one (ex.: aim behaviour, combat behaviour).
